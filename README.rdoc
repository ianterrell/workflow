...
Workflow is a business process management engine written in Ruby using ActiveRecord for persistence.
...
This implementation draws much inspiration from the Java project jBPM (http://www.jboss.org/jbpm) and the work of The Workflow Patterns Initiative (http://workflowpatterns.com).

== Distinguishing Features

Workflow provides a significant number of workflow related features that ActiveModel::StateMachine and other implementations do not:
...
Workflow is under active development.  Version 1 will include functionality common to most simple but non-trivial workflow processes, and includes support for
